            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
              ...
              <div className="flex flex-col items-start text-left">
                ...
                <h1 className="mt-6 text-4xl font-bold tracking-tight sm:text-5xl xl:text-6xl font-sans">
                  Scale faster with high-performance VPS
                </h1>

                {/* Subtitle */}
                <p className="mt-4 text-lg text-muted-foreground font-sans">
                  Ideal for developers, agencies and websites needing
                  scalability.
                </p>
                ...
                <ul className="mt-6 space-y-3 text-sm font-medium">
                  <li className="flex items-center gap-2">
                    ...
                    <span>AMD EPYC processors and NVMe SSD storage</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-green-500" />
                    <span>Dedicated resources (no sharing, no slowdowns)</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-green-500" />
                    <span>Full control with root access &amp; custom setup</span>
                  </li>
                </ul>

                {/* Price Box & CTA */}
                <div className="mt-8 flex items-baseline gap-2">
                  <span className="text-4xl font-extrabold">₹549</span>
              ...
              <div className="relative flex items-center justify-center lg:justify-end w-full h-full">
                ...
                <div className="relative w-full aspect-[1280/930] overflow-hidden rounded-2xl">
                  <Image
                    src="https://www.milesweb.in/assets/img/vps-hosting/vps-hosting.avif"
