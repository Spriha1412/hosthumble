            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
              ...
              <div className="flex flex-col items-start text-left">
                ...
                >
                  ...
                  <span>Get 82% Off Hosting with Free Domain</span>
                ...
                <p className="mt-4 text-lg text-muted-foreground font-sans">
                  Powerful hosting. Honest renewals. Launch your website in
                  minutes with full cPanel control.
                </p>
                ...
                <ul className="mt-6 space-y-3 text-sm font-medium">
                  <li className="flex items-center gap-2">
                    ...
                    <span>NVMe storage for faster loading</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-green-500" />
                    <span>LiteSpeed-powered performance</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="size-4 text-green-500" />
              ...
              <div className="relative flex items-center justify-center lg:justify-end w-full h-full">
                ...
                <div className="relative w-full aspect-[1280/930] overflow-hidden rounded-2xl">
                  <Image
                    src="https://www.milesweb.in/assets/img/cpanel-hosting/cpanel-hosting-1280x930.avif"
